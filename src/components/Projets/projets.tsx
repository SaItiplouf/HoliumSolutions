            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-8">
                <div className="max-w-sm h-64 w-full mx-auto sm:mx-0 relative rounded-md overflow-hidden shadow-lg">
                    ...
                    >
                        ...
                        <div
                            className="absolute inset-0 bg-gradient-to-b from-transparent  via-transparent to-black opacity-45"></div>

                        {/* Contenu en bas de la carte */}
                        <div className="flex flex-col justify-end h-full relative z-10">
                            <div className="flex items-center justify-start">
                                <h2 className="text-white text-xl font-bold mb-2">E-commerce</h2>
                            </div>
                ...
                <div className="max-w-sm h-64 w-full mx-auto sm:mx-0 relative rounded-md overflow-hidden shadow-lg">
                    ...
                    >
                        ...
                        <div className="flex flex-col justify-end h-full relative z-10">
                            <div className="flex items-center justify-start">
                                <h2 className="text-white text-xl font-bold mb-2">Site Vitrine</h2>
                            </div>
                ...
                <div className="max-w-sm h-64 w-full mx-auto sm:mx-0 relative rounded-md overflow-hidden shadow-lg">
                    ...
                    >
                        ...
                        <div className="flex flex-col justify-end h-full relative z-10">
                            <div className="flex items-center justify-start">
                                <h2 className="text-white text-xl font-bold mb-2">Applications interne</h2>
                            </div>
